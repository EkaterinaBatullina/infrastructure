...
Репозиторий содержит [конфигурацию инфраструктуры на GitLab](https://gitlab.com/EkaterinaBatullina/infrastructure), CI/CD пайплайнов и сценарии развертывания микросервисной системы в облачной среде.
