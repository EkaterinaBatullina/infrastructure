...
ssh "$SSH" "sudo docker pull registry.gitlab.com/EkaterinaBatullina/infrastructure2/agona-05:$TAG"

ssh "$SSH" "sudo docker-compose -p $BRANCH -f ~/infrastructure2/docker/docker-compose.$TAG.yml down"
